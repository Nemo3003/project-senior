...
const Signup = async (req, res) => {
  ...
  try {
    ...
    const checkQuery = "SELECT * FROM ocacoplusdb.ocacoplus.users WHERE username = ? OR email = ?";
    ...
    bcrypt.hash(password.toString(), salt, (err, hash) => {
      ...
      const insertQuery = `INSERT INTO ocacoplusdb.ocacoplus.users (username, password, email) VALUES (${username}, ${hash}, ${email})`;
