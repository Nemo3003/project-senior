...
const Signup = async (req, res) => {
  ...
  try {
    ...
    const checkQuery = "SELECT * FROM ocacoplusdb.users WHERE username = ? OR email = ?";
    ...
    bcrypt.hash(password.toString(), salt, (err, hash) => {
      ...
      const insertQuery = `INSERT INTO ocacoplusdb.users (username, password, email) VALUES (${username}, ${hash}, ${email})`;
