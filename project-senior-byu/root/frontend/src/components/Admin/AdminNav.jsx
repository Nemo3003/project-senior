    ...
    <nav className="bg-blue-600">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-4 flex items-center md:ml-6">
              ...
              <Link to="/admin/stuclass" className="ml-4 px-3 py-2 rounded-md text-sm font-medium text-white hover:bg-blue-500">Enrollments</Link>
              <Link to="/admin/upload" className="ml-4 px-3 py-2 rounded-md text-sm font-medium text-white hover:bg-blue-500">Student Files</Link>
            </div>
          </div>
      ...
      <div className={`${isMenuOpen ? 'block' : 'hidden'} md:hidden`}>
        ...
        <Link to="/auth-courses" className="mt-1 block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-blue-500 transition duration-150 ease-in-out">See classes</Link>
          ...
          <Link to="/admin/stuclass" className="mt-1 block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-blue-500 transition duration-150 ease-in-out">Enrollments</Link>
          <Link to="/admin/upload" className="mt-1 block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-blue-500 transition duration-150 ease-in-out">Student Files</Link>
